        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <form action="">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mb-2">
                        <input wire:mode="postId" type="hidden">
                        <label for="title" class="block">Title</label>
                        <input wire:model="title" type="text" name="title" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900" placeholder="Create your title here">
                    </div>
                    <div class="mb-2">
                        <label for="title" class="block">Description</label>
                        <textarea wire:model="description" type="text" name="title" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900" placeholder="Describe your post here"></textarea>
                    </div>
                </div>
